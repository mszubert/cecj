...
public class WPCSequenceVisualizer {
	...
	private PdfPTable createTable(double[] wpc) {
		...
		for (int i = 0; i < WPC_LENGTH; i++) {
			...
			//cell.setBackgroundColor(new GrayColor((max - (float)wpc[i]) / (max - min)));
			cell.setBackgroundColor(new GrayColor(0.5f - ((float)wpc[i] / 2.0f)));
...
//			}
	...
	public void visualize2(String fileIn, String fileOut, int limit, int frequency) {
	...
	public static void main(String[] args) {
		...
		vis.visualize2("ctdl-go/ind_6946.stat", "out.pdf", 50, 1);
